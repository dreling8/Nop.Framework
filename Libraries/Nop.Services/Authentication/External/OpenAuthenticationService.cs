...
namespace Nop.Services.Authentication.External
{
    ...
    public partial class OpenAuthenticationService : IOpenAuthenticationService
    {
       ...
       // private readonly IPluginFinder _pluginFinder;
        ...
        public virtual IList<IExternalAuthenticationMethod> LoadActiveExternalAuthenticationMethods(User customer = null, int storeId = 0)
        {
        ...
        public virtual IList<IExternalAuthenticationMethod> LoadAllExternalAuthenticationMethods(User customer = null, int storeId = 0)
        {
            //TODO plugin moudle
        ...
        public virtual void AssociateExternalAccountWithUser(User customer, OpenAuthenticationParameters parameters)
        {
            if (customer == null)
        ...
        public virtual User GetUser(OpenAuthenticationParameters parameters)
        {
            ...
            if (record != null)
                return _customerService.GetUserById (record.UserId);
        ...
        public virtual IList<ExternalAuthenticationRecord> GetExternalIdentifiersFor(User customer)
        {
            if (customer == null)
                throw new ArgumentNullException("customer");
