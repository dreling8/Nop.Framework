...
namespace Nop.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual string GetSiteUrl(bool includeQueryString)
        {
            bool useSsl = IsCurrentConnectionSecured();
            return GetSiteUrl(includeQueryString, useSsl);
        }
        ...
        /// <returns>Page name</returns>
        public virtual string GetSiteUrl(bool includeQueryString, bool useSsl)
        {
            if (!IsRequestAvailable(_httpContext))
                return string.Empty;

            //get the host considering using SSL
            var url = GetSiteHost(useSsl).TrimEnd('/');
